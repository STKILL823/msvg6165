...
function renderRows(rows) {
  ...
  const header=document.createElement('tr');['Сервер','Строка',...dataColumns,'Исполнитель','Статус'].forEach(label=>{const th=document.createElement('th');th.textContent=label;header.append(th)});head.append(header);
