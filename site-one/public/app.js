...
const translations = {
  ru: {
    welcome: 'Добро пожаловать в технический отдел 61-65',
  ...
  en: {
    welcome: 'Welcome to Technical Department 61-65', languageTitle: 'Language',
  ...
  uk: {
    welcome: 'Ласкаво просимо до технічного відділу 61-65', languageTitle: 'Мова — Language',
  ...
  de: {
    welcome: 'Willkommen in der technischen Abteilung 61-65', languageTitle: 'Sprache — Language',
  ...
  fr: {
    welcome: 'Bienvenue au service technique 61-65', languageTitle: 'Langue — Language',
